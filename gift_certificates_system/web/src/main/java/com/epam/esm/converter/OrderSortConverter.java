...
/**
 * Class {@code OrderSortConverter} uses to convert request parameter to {@link SortOrder}.
 *
 * @author Egor Shitikov
 * @version 1.0
 */
public class OrderSortConverter implements Converter<String, SortOrder> {
