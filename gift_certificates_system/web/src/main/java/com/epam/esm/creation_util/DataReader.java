...
public class DataReader {
    ...
    public static void writePasswordFile(List<UserRegistrationDto> users) throws IOException {
        Path path = Files.createFile(Paths.get("C:/Users/shitikov_egor/IdeaProjects/MJCS/Gift " +
                "Certificates System/for_generate_db/password.txt"));
    ...
    public static void writePasswordFile(Map<String, String> users) throws IOException {
        Path path = Files.createFile(Paths.get("C:/Users/shitikov_egor/IdeaProjects/MJCS/Gift " +
                "Certificates System/for_generate_db/password.txt"));
